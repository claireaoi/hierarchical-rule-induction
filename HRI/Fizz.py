...
from utils.Dataset import FizzDataset
...
'''
Default hyper parameters to run this script: python Fizz.py --visualize 0 --use_noise --model xxx
'''

parser = argparse.ArgumentParser()
parser.add_argument('--task_name', default='Fizz', type=str, choices=['Fizz'], help='task name')
parser.add_argument('--train_steps', default=8, type=int, help='inference(forward) step for training')
...
parser.add_argument('--head_noise_scale', default=1.0, type=float, help='hyperparameters for noise')
parser.add_argument('--head_noise_decay', default=0.5, type=float)
parser.add_argument('--head_noise_decay_epoch', default=30, type=int, help='hyperparameters for noise')
parser.add_argument('--body_noise_scale', default=1.0, type=float, help='hyperparameters for noise')
parser.add_argument('--body_noise_decay', default=0.5, type=float, help='hyperparameters for noise')
parser.add_argument('--body_noise_decay_epoch', default=60, type=int, help='hyperparameters for noise')
parser.add_argument('--train_num_constants', default=7, type=int, help='the number of constants for training data')
