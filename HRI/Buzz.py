...
from utils.Dataset import BuzzDataset
...
'''
Default hyper parameters to run this script: python Buzz.py --visualize 0 --num_runs 200 --use_noise --model xxx
'''

parser = argparse.ArgumentParser()
parser.add_argument('--task_name', default='Buzz', type=str, choices=['Buzz'], help='task name')
...
parser.add_argument('--eval_num_constants', default=16, type=int, help='the number of constants for evaluation data')
