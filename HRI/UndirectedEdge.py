...
from utils.Dataset import UndirectedEdgeDataSet
...
parser.add_argument('--task_name', default='UndirectedEdge', type=str, choices=['UndirectedEdge'], help='task name')
parser.add_argument('--train_steps', default=2, type=int, help='inference(forward) step for training')
...
parser.add_argument('--train_num_constants', default=4, type=int, help='the number of constants for training data')
