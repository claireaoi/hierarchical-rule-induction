...
from utils.Dataset import EvenOddDataset
...
'''
Default hyper parameters to run this script: python EvenOdd.py --use_noise --model xxx
'''

parser = argparse.ArgumentParser()
parser.add_argument('--task_name', default='EvenOdd', type=str, choices=['EvenOdd'], help='task name')
parser.add_argument('--train_steps', default=6, type=int, help='inference(forward) step for training')
parser.add_argument('--eval_steps', default=8, type=int, help='inference(forward) step for evaluation')
