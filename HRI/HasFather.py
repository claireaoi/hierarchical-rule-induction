...
'''
Default hyper parameters to run this script: python HasFather.py --use_noise --visualize 0 --model xxx
'''

parser = argparse.ArgumentParser()
parser.add_argument('--task_name', default='HasFather', type=str, choices=['HasFather'], help='task name')
parser.add_argument('--train_steps', default=1, type=int, help='inference(forward) step for training')
parser.add_argument('--eval_steps', default=2, type=int, help='inference(forward) step for evaluation')
...
parser.add_argument('--train_num_constants', default=12, type=int, help='the number of constants for training data')
