...
from utils.Dataset import LessThanDataset
...
'''
Default hyper parameters to run this script: python LessThan.py --use_noise --model xxx
'''
parser = argparse.ArgumentParser()
parser.add_argument('--task_name', default='LessThan', type=str, choices=['LessThan'], help='task name')
parser.add_argument('--train_steps', default=12, type=int, help='inference(forward) step for training')
...
parser.add_argument('--train_num_constants', default=10, type=int, help='the number of constants for training data')
parser.add_argument('--eval_num_constants', default=12, type=int, help='the number of constants for evaluation data')
