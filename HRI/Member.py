...
from utils.Dataset import MemberDataset
...
'''
Default hyper parameters to run this script: python Member.py --num_runs 100 --model default --unif cosine --clamp True --num_iters 1200
'''

parser = argparse.ArgumentParser()
parser.add_argument('--task_name', default='Member', type=str, choices=['Member'], help='task name')
...
parser.add_argument('--eval_num_constants', default=7, type=int, help='the number of constants for evaluation data')
