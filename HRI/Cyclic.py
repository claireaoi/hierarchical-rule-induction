...
from utils.Dataset import CyclicDataset
...
parser.add_argument('--task_name', default='Cyclic', type=str, choices=['Cyclic'], help='task name')
...
parser.add_argument('--train_num_constants', default=6, type=int, help='the number of constants for training data')
